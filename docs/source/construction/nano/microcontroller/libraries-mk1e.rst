...
-   :ref:`mk1eArduinoLibrary`
-   :ref:`mk1ePlatformIOLibrary`
...
You will see a pop-up window telling you that you also need to install the CowPi_stdio library (:numref:`mk1eInstallingArduinoLibraries`).


..  _mk1eInstallingArduinoLibraries:
